...
$args = array(
	...
	'menu_title'                => esc_html__( 'Global Options', 'Ink-House' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Global Options', 'Ink-House' ),
...
$args['admin_bar_links'][] = array(
	'id'    => 'redux-docs',
	'href'  => '//devs.redux.io/',
	'title' => __( 'Documentation', 'Ink-House' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-support',
	'href'  => '//github.com/ReduxFramework/redux-framework/issues',
	'title' => __( 'Support', 'Ink-House' ),
);
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', 'Ink-House' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
	$args['intro_text'] = '<p>' . esc_html__( 'This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'Ink-House' ) . '</p>';
}

// Add content after the form.
$args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'Ink-House' ) . '</p>';
...
$help_tabs = array(
	array(
		'id'      => 'redux-help-tab-1',
		'title'   => esc_html__( 'Theme Information 1', 'Ink-House' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'Ink-House' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
		'title'   => esc_html__( 'Theme Information 2', 'Ink-House' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'Ink-House' ) . '</p>',
	),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'Ink-House' ) . '</p>';
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header', 'Ink-House' ),
		'id'               => 'header',
		'desc'             => esc_html__( 'Header fields!', 'Ink-House' ),
		'icon'             => 'el el-home',
		'fields'           => array(
			array(
				'id'       => 'header-logo',
				'type'     => 'media',
				'url'      => true,
				'title'    => esc_html__( 'Header Logo', 'Ink-House' ),
				'desc'     => esc_html__( 'Upload Logo', 'Ink-House' ),
			),
			array(
				'id'       => 'header-basket',
				'type'     => 'media',
				'url'      => true,
				'title'    => esc_html__( 'Header basket', 'Ink-House' ),
				'desc'     => esc_html__( 'Upload basket', 'Ink-House' ),
			),
		),
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Footer', 'Ink-House' ),
		'id'               => 'footer',
		'desc'             => esc_html__( 'Header fields!', 'Ink-House' ),
		...
		'fields'           => array(
			array(
				...
				'type'     => 'media',
				'url'      => true,
				'title'    => esc_html__( 'Footer Logo', 'Ink-House' ),
				'desc'     => esc_html__( 'Upload Logo', 'Ink-House' ),
			),
			array(
				'id'       => 'footer-number',
				'type'     => 'text',
				'title'    => esc_html__( 'Footer Number', 'Ink-House' ),
				'desc'     => esc_html__( 'Upload Logo', 'Ink-House' ),
			),
			array(
				'id'       => 'footer-title',
				'type'     => 'text',
				'title'    => esc_html__( 'Footer Title', 'Ink-House' ),
				'desc'     => esc_html__( 'Upload Logo', 'Ink-House' ),
			),
			array(
				'id'       => 'footer-Facebook',
				'type'     => 'text',
				'title'    => esc_html__( 'Facebook', 'Ink-House' ),
			),
			array(
				'id'       => 'footer-Instagram',
				'type'     => 'text',
				'title'    => esc_html__( 'Instagram', 'Ink-House' ),
			),
			array(
				'id'       => 'footer-YouTube',
				'type'     => 'text',
				'title'    => esc_html__( 'YouTube', 'Ink-House' ),
			),
		),
	)
);
...
if ( ! function_exists( 'dynamic_section' ) ) {
	...
	function dynamic_section( array $sections ): array {
		$sections[] = array(
			'title'  => esc_html__( 'Section via hook', 'Ink-House' ),
			'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'Ink-House' ) . '</p>',
...
if ( ! function_exists( 'change_defaults' ) ) {
	...
	function change_defaults( array $defaults ): array {
		$defaults['str_replace'] = esc_html__( 'Testing filter hook!', 'Ink-House' );
